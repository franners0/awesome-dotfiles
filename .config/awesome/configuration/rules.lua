...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule {
        ...
        properties = {floating = true, size_hints_honor = true, raise = true}
    ...
    ruled.client.append_rule {
        ...
        rule_any = {
            type = {"dialog"},
            class = {"markdown_input", "scratchpad"},
    ...
    ruled.client.append_rule {
        ...
        ruled.client.append_rule {
            ...
            properties = {floating = true, fullscreen = true, placement = awful.placement.top,  titlebars_enabled = false,}
